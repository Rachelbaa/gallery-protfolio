var gProjs = [
    // createProj('weather', 'Weather', 'weather app', 'A user-friendly and responsive weather app offering global city search and real-time weather updates, along with the functionality to save favorite locations for quick access.', 'https://rachelbaa.github.io/Rachel-Furman-08-09-2022/#/', '04 / 09 / 2022', 'VueJs, current weather API, local storage'),
    createProj('vuechat', 'VueChat', 'whatsApp web clone', 'a MEVN stack app (mongoDB, Express, VueJS-3B, Node-JS)- cloudinary, SCSS, Express, Element Plus, socket.io, emailJs, Session and more , picxel perfect of whatsApp web application, with a guest user and chat bot', 'https://rachel-chat-hywm.onrender.com/#/', '15 / 08 / 2022', 'VueJs, Mongo-DB, cloudinary, Socket.io, Typescript, nodeJS, MEVN application'),
    createProj('mister-toy', 'Toy Store', 'Go and buy some toys (:', 'Used VueJS-3 with mongoDB, cloudinary, SCSS, Node-JS, Element Plus, socket.io and more , admin middle-ware (admin-username: rachel, admin-password: 111)', 'https://rachels-toys.onrender.com/#/', '18 / 06 / 2022', 'VueJs, Mongo-DB, cloudinary'),
